  ...
  <div class="container">
    <div class="main row">
      <div class="col-md-8 blog_left">
        <h2 class="style">Things to Do</h2>
        <div class="blog_main">
          <a href="single-page.html"><img src="{{URL::to('/')}}/assets/images/Bandung.jpg" alt="" class="blog_img img-responsive"/></a>
          <h4><a href="single-page.html">7 Awesome Things to Do in Bandung</a></h4>
        ...
        <div class="blog_main">
          ...
          <div class="clearfix"></div>
          <p class="para">Our 10 Best Things to Do in Bali take you straight to the ‘can’t miss’ cultural treasures and famous landscapes found all around the magical island of Bali. There are innumerable temples, historical sites, and spots of natural beauty spread across eight regencies. This narrowing-down of choices will get you discovering the best of Bali in no time. Go east to see the majestic 'mother temple' of Besakih or travel to the heartland where rice paddies offer scenic photo opportunities. From scenic vistas to cultural performances, there is something for everyone.</p>
          <div class="read_more btm">
            <a href="single-page.html">view more</a>
          </div>
        </div>
